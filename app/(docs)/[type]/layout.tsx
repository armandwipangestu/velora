...
export default async function DocsLayout({ children, params }: DocsLayoutProps) {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            />
            <div className="container flex-1 items-start md:grid md:grid-cols-[240px_minmax(0,1fr)_240px] md:gap-6 lg:grid-cols-[280px_minmax(0,1fr)_280px] lg:gap-10">
                ...
                <main className="relative py-6 lg:gap-10 lg:py-8 xl:grid xl:grid-cols-[1fr_minmax(0,1fr)]">
