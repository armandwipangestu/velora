...
export default function Home() {
  ...
  return (
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 mt-8 md:mt-10 lg:py-32">
        <div className="container flex flex-col gap-4 text-center">
          ...
          <div className="flex flex-col gap-4 justify-center sm:flex-row ">
            ...
            <Link href={siteConfig.links.github} target="_blank" rel="norefferrer noopener" className={cn(buttonVariants({
              variant: "outline",
              size: "lg"
            }), "w-full sm:w-fit")}>
              GitHub
