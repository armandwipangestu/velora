---
title: Example Twoslash
description: This post is to see twoslash
date: 2025-12-26
tags:
    - twoslash
    - typescript
...
```sh icon="iNpm" title="npm"
npm install -D @shikijs/twoslash
```

```sh icon="iYarn" title="yarn"
yarn add -D @shikijs/twoslash
```

```sh icon="iPnpm" title="pnpm"
pnpm add -D @shikijs/twoslash
```

```sh icon="iBun" title="bun"
