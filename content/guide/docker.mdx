...
You can see how velora add CI Pipeline automation to release and push docker image to GitHub Container Registry in <a className='text-[#10b981]' href="https://github.com/armandwipangestu/velora/blob/main/.github/workflows/release.yml" target="_blank">release.yml</a>. You can also pull the latest docker image velora using the following command.

```bash
docker pull ghcr.io/armandwipangestu/velora:latest
```
